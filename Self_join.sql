...
/* Q4: The query shown gives the number of routes that visit either London Road (149) or Craiglockhart (53).
...
/* Q5: Execute the self join shown and observe that b.
...
/* Q6: The query shown is similar to the previous one,
...
/* Q9: Give a distinct list of the stops which may be reached from 'Craiglockhart' by taking one bus,
